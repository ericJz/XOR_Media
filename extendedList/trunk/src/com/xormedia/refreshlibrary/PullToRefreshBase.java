...
import com.xormedia.refreshlibrary.internal.FlipLoadingLayout;
import com.xormedia.refreshlibrary.internal.ILoadingLayout;
import com.xormedia.refreshlibrary.internal.IPullToRefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static enum Mode {
		 ...
		 * scrolling direction.
		 */
		PULL_FROM_END(0x2),// 上拉加载更多

		/**
		 * Allow the user to both Pull from the start, from the end to refresh.
		 */
		BOTH(0x3),// 下拉刷新,上拉加载更多
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				PullToRefreshBase.this.postDelayed(this, 0);
			} else {
				if (null != mListener) {
